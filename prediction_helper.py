...
model_young = joblib.load(
    os.path.join(BASE_DIR, "artifacts", "model_young.joblib")
)

model_rest = joblib.load(
    os.path.join(BASE_DIR, "artifacts", "model_rest.joblib")
)

scaler_young = joblib.load(
    os.path.join(BASE_DIR, "artifacts", "scaler_young.joblib")
)

scaler_rest = joblib.load(
    os.path.join(BASE_DIR, "artifacts", "scaler_rest.joblib")
)
